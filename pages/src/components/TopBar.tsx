...
import { Search, Bell, ChevronDown, Plus, GitBranch } from "lucide-react";
  ...
  return (
    <header className="sticky top-0 z-30 h-16 border-b border-[var(--color-dark-border)] bg-[var(--color-dark-surface)]/80 backdrop-blur-xl flex items-center justify-between px-6">
      ...
      <div className="flex items-center gap-4 ml-6">
        ...
        {/* Avatar / Login */}
        <button className="flex items-center gap-2.5 px-2 py-1.5 rounded-xl hover:bg-[var(--color-dark-hover)] transition-all group">
          ...
          <div className="hidden md:block text-left">
            <p className="text-xs font-medium text-white">slime_dev</p>
            <p className="text-[10px] text-slime-400">Pro Plan</p>
          </div>
