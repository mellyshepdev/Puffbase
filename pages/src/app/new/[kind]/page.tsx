...
const KINDS: Record<string, KindConfig> = {
  repository: {
    ...
    fields: [
      ...
      { key: "gitignore", label: "Add .gitignore", kind: "select", options: [
        { value: "", label: "None" },
        { value: "Node", label: "Node" }, { value: "Python", label: "Python" },
        { value: "Go", label: "Go" }, { value: "Rust", label: "Rust" },
        { value: "Java", label: "Java" }, { value: "C++", label: "C/C++" },
        { value: "Ruby", label: "Ruby/Rails" }, { value: "Unity", label: "Unity" },
        { value: "VisualStudio", label: "Visual Studio" },
      ], show: (v) => v.source === "blank", help: "Commits a .gitignore tuned for that stack - build output, dependencies, OS junk stay out of your history. Templates already ship their own." },
    ...
    build: (v) => ({
      ...
      gitignore: v.gitignore || undefined,
